...
gmm_1 = read.csv("/home/ysalimi/Yasamin/git/maad/results/clustering/gmm/A-T-N-_gmm_corrected_v2.csv")
gmm_2 = read.csv("/home/ysalimi/Yasamin/git/maad/results/clustering/gmm/A-T+N+_gmm_corrected_v2.csv")
gmm_3 = read.csv("/home/ysalimi/Yasamin/git/maad/results/clustering/gmm/A-T-N+_gmm_corrected_v2.csv")
gmm_4 = read.csv("/home/ysalimi/Yasamin/git/maad/results/clustering/gmm/A+T+N-_gmm_corrected_v2.csv")
gmm_5 = read.csv("/home/ysalimi/Yasamin/git/maad/results/clustering/gmm/A+T-N-_gmm_corrected_v2.csv")
gmm_6 = read.csv("/home/ysalimi/Yasamin/git/maad/results/clustering/gmm/A+T-N+_gmm_corrected_v2.csv")
gmm_7 = read.csv("/home/ysalimi/Yasamin/git/maad/results/clustering/gmm/A+T+N+_gmm_corrected_v2.csv")
...
km_1 = read.csv("/home/ysalimi/Yasamin/git/maad/results/clustering/k_means/A-T-N-_km_corrected_v2.csv")
km_2 = read.csv("/home/ysalimi/Yasamin/git/maad/results/clustering/k_means/A-T+N+_km_corrected_v2.csv")
km_3 = read.csv("/home/ysalimi/Yasamin/git/maad/results/clustering/k_means/A-T-N+_km_corrected_v2.csv")
km_4 = read.csv("/home/ysalimi/Yasamin/git/maad/results/clustering/k_means/A+T+N-_km_corrected_v2.csv")
km_5 = read.csv("/home/ysalimi/Yasamin/git/maad/results/clustering/k_means/A+T-N-_km_corrected_v2.csv")
km_6 = read.csv("/home/ysalimi/Yasamin/git/maad/results/clustering/k_means/A+T-N+_km_corrected_v2.csv")
km_7 = read.csv("/home/ysalimi/Yasamin/git/maad/results/clustering/k_means/A+T+N+_km_corrected_v2.csv")
